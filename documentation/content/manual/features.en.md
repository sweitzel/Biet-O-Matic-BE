...
{{< image src="features_be_group.de.png" alt="Groups" >}}
...
{{< image src="features_be_article_log.de.gif" alt="Article event log" >}}
...
{{< image src="features_be_article_page.de.gif" alt="Article_page" >}}
